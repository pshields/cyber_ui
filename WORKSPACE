...
http_archive(
    name = "rules_proto",
    sha256 = "a8e02373affa5ebd2c92efcac8181704b04d6ff16152edeb7c5e3e9b6520eddd",
    strip_prefix = "rules_proto-860e9005506b91507d9b18cae7db30cd5ee37c3d",
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/rules_proto/archive/860e9005506b91507d9b18cae7db30cd5ee37c3d.tar.gz",
        "https://github.com/bazelbuild/rules_proto/archive/860e9005506b91507d9b18cae7db30cd5ee37c3d.tar.gz",
    ],
)
...
# Golang support
# TODO Replace with a release once ac1b0e0 makes it into a release
load("@bazel_tools//tools/build_defs/repo:git.bzl", "git_repository")

git_repository(
    name = "io_bazel_rules_go",
    remote = "https://github.com/bazelbuild/rules_go.git",
    commit = "86a47dd0e3c8b23feef0712db99624f3ce8ea548",
)
...
# Gazelle (Golang build file generator for Bazel)
http_archive(
    name = "bazel_gazelle",
    urls = [
...
go_repository(
    ...
    sum = "h1:qPnAdmjNA41t3QBTx2mFGf/SD1IoslhYu7AmdsVzCcs=",
    version = "v0.0.0-20190926025831-c00fd9afed17",
)
